...
//parking marker design

var parkingIcon = L.divIcon({
    className: 'parking-icon',
    html: "<div style='background-color:#28a745; color:white; width:25px; height:25px; border-radius:3px; display:flex; align-items:center; justify-content:center; font-weight:bold; border:2px solid white;'>P</div>",    iconSize: [25, 25],
    iconAnchor: [12, 12]
});
...
//adding parking markers

var parkingList = [];

parkingList.push(L.marker([45.390687949224855, -75.69671678046406], {icon: parkingIcon}).bindPopup("Parking P7"));
